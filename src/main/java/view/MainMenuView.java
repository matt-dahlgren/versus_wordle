...
public class MainMenuView extends JPanel {
    ...
    public MainMenuView() {
        ...
        topPanel.setBackground(ColourConstants.PURPLE);
        add(topPanel);
        ...
        titleLabel.setBackground(ColourConstants.PURPLE);
        ...
        buttonPanel.setBackground(ColourConstants.PURPLE);
        ...
        JButton versusComputer = new JButton("Versus Computer");
        ...
        fourthPanel.setBackground(ColourConstants.PURPLE);
        add(fourthPanel);

        // Add a panel with some disclosing information
        JPanel bottomPanel = new JPanel(new BorderLayout());
        bottomPanel.setBackground(ColourConstants.PURPLE);
        ...
        singleLineLabel.setBackground(ColourConstants.PURPLE);
